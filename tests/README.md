...
- `e2e.test.js` — Puppeteer browser tests covering DOM wiring: tap-to-end-turn
  and its debounce, jump-to-player, admin overlay (long-press entry, time
  edits, deactivating the current player), overdraft styling, and — the one
